            ...
            <div class="col-lg-6 mb-5 mb-lg-0">
                ...
                <form>
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <input type="tel" class="form-control border border-primary" id="phone" placeholder="Your Phone Number" required>
                                <label for="phone">Your Phone Number</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea class="form-control border border-primary" placeholder="Your Message" id="message" style="height: 150px" required></textarea>
